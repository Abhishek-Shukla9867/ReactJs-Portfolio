...
function About() {
  return (
    <>
      <div
        name="About"
        className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-20 -mt-5 bg-black text-yellow-600  "
      >
        <div className="flex  justify-between   md:flex-row   flex-col">
          <div className="left md:w-1/2    space-y-2 order-1 md:order-1">
            <h1 className=" text-4xl font-bold text-center     bg-black text-yellow-600">
              {" "}
              LET ME INTRODUCE
            ...
            <p className="text-lg leading mb-6">
              ...
              <span className="text-blue-800">HTML5,CSS3 Javascript</span> and{" "}
              <span className="text-blue-800">ReactJS.</span>
            </p>

            <p className="text-lg leading mb-6">
              My field of Interest`s are building new Web Technologies and
              Products and also in areas related to Gaming.
            </p>
          ...
          <div className=" right md:w-1/2 md:ml-48  sm:mt-2 order-2>right order-2 ">
            <img
              alt="Coder GIF"
              className="md:w-[450px] md:h-[250px] md:-mt-18 rounded-lg"
      ...
      <div className="flex items-center justify-center  -mt-20  mb-5   bg-black text-yellow-600 ">
